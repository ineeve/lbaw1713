    ...
    jQuery('#scroll_advanced_search_users').click(function (e) {
        ...
        jQuery.ajax({
            ...
            success: function (result) {
                if(result.next == 0){
                    $('#users_item_preview_list').append("<div style=\"width: 100%\" class=\"alert alert-dismissible alert-secondary\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button><strong>Sorry!</strong> No more users at the moment!</div>");
                } else {
