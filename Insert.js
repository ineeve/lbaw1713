...
function createNews(){
    ...
    for (let i = 0; i < 1000; i++){
        ...
        news.section_id = Math.floor(rndNum * 10);
        news.author_id = Math.floor(rndNum * 100);
        newsArray.push(news);
    }
    return newsArray;
}
...
function printNewsSql(newsArray){
    ...
    let stream = fs.createWriteStream("InsertNews.sql");
    stream.once('open', () => {
