...
@foreach ($commentreports as $report)
   <tr class="table-light">
        ...
        <td style="width: 16.67%; height: 25%;">{{ date("F jS, Y \a\\t H:i", strtotime($report->commentdate)) }}</td>
        ...
        <td style="width: 16.67%; height: 25%;">{{ date("F jS, Y \a\\t H:i", strtotime($report->reportdate)) }}</td>
